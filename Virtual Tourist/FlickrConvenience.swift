...
extension FlickrClient {
    ...
    func getPhotosForCoordinate(#latitude: Double, longitude: Double, page: Int, completionHandler: (data: AnyObject?, error: NSError?) -> Void) {
        ...
        let parameters = [
            ...
            MethodArgumentKeys.PAGE             : String(page)
        ]
